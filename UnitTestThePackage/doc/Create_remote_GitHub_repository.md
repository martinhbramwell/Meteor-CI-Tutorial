...
The steps are :
 ...
 - Log in to [GitHub](https://github.com/) as ```${PROJECT_NAME}``` and create a project with the exact name ```${PROJECT_NAME}```. Don't set any other values. We'll do that automatically.
