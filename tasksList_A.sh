...
export arrFunctionDefinitions=(
  ...
  "03|UnitTestAModule|Create_a_module_B|Created module '${MODULE_NAME}' : (B)|, but [ci skip].|"
  "03|UnitTestAModule|Create_a_module_C|Created module '${MODULE_NAME}' : (C)|, but [ci skip].|"
  "03|UnitTestAModule|Create_GitHub_Repo_Deploy_Keys_for_Module|Created GitHub Repo Deploy Keys for '${MODULE_NAME}'|, but [ci skip].|"
  "03|UnitTestAModule|Create_GitHub_Repo_For_Module|Created GitHub Repo for '${MODULE_NAME}'|, but [ci skip].|"
  "03|UnitTestAModule|Add_GitHub_Repo_Deploy_Key_For_Module|Added GitHub Repo Deploy Key for '${MODULE_NAME}' |, but [ci skip].|"
  "03|UnitTestAModule|Control_a_modules_versions_B_nonstop|Controlled '${MODULE_NAME}' module's versions : B|, but [ci skip].|"
